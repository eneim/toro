 ...
 */
public class SimpleVideoListFragment extends RecyclerViewFragment {

  public static final String TAG = "SimpleVideoListFragment";

  public static SimpleVideoListFragment newInstance() {
    return new SimpleVideoListFragment();
  }
  ...
  @NonNull @Override protected RecyclerView.Adapter getAdapter() {
    return new SimpleVideoListAdapter();
  }
}
