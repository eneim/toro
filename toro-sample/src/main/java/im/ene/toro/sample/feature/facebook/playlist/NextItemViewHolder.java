...
public class NextItemViewHolder extends ExtPlayerViewHolder {

  static final int LAYOUT_RES = R.layout.vh_playlist_item_next;

  public NextItemViewHolder(View itemView) {
    super(itemView);
  }
