...
public class EMAudioPlayer {
    ...
    /**
     * Starts the playback for the audio item specified in {@link #setDataSource(Context, Uri)}.
     ...
     *
     * @return A list of available tracks associated with each track type (see {@link TrackRenderType})
     */
    @Nullable
