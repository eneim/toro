 ...
 */
package develop.com.google.android.exoplayer.demo;
...
import develop.com.google.android.exoplayer.demo.player.DashRendererBuilder;
import develop.com.google.android.exoplayer.demo.player.DemoPlayer;
...
public class PlayerActivity extends Activity
    implements SurfaceHolder.Callback, OnClickListener, DemoPlayer.Listener,
   ...
   */
  @TargetApi(23) private boolean maybeRequestPermission() {
  ...
  private void configurePopupWithTracks(PopupMenu popup,
      final OnMenuItemClickListener customActionClickListener, final int trackType) {
    if (player == null) {
      return;
    }
  ...
  private static final class KeyCompatibleMediaController extends MediaController {
    ...
    @Override public void setMediaPlayer(MediaPlayerControl playerControl) {
