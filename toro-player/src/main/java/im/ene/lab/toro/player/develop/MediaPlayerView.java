...
public class MediaPlayerView extends TextureView
  ...
  private SurfaceTextureListener mSurfaceTextureListener = new SurfaceTextureListener() {
    @Override public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
      MediaPlayerView.this.mSurface = new Surface(surface);
      if (mMediaPlayer != null) {
        mMediaPlayer.setSurface(MediaPlayerView.this.mSurface);
  ...
  /**
   * Set the aspect ratio that this {@link MediaPlayerView} should satisfy.
   *
