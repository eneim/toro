 ...
 */
public class SimpleListAdapter extends ToroAdapter<SimpleVideoViewHolder> {

  @Nullable @Override protected Object getItem(int position) {
    return new VideoItem();
  }

  @Override public SimpleVideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
