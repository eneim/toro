...
public class BaseMeter<T extends BandwidthMeter, S extends TransferListener<Object>>
    implements BandwidthMeter, TransferListener {

  @NonNull private final T bandwidthMeter;
  @NonNull private final S transferListener;
